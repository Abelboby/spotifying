      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide:
                BorderSide(color: const Color(0xFF1DB954).withOpacity(0.5)),
          ),
          contentPadding:
...
class GroupListScreen extends StatelessWidget {
      ...
      builder: (context, membersSnapshot) {
        ...
        if (membersSnapshot.hasData) {
          ...
          pendingMembers = membersSnapshot.data!.docs
              .where((doc) => !(doc['payments'][currentMonth] ?? false))
              .length;
        }
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                '$pendingMembers ${pendingMembers == 1 ? 'member has' : 'members have'} pending payments',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall
                                    ?.copyWith(
  ...
  void _showGroupActions(BuildContext context, DocumentSnapshot group) {
    showModalBottomSheet(
      context: context,
